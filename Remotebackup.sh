###################################################################
#Script Name : RemoteBackup.sh
#Description : Script that makes an incremental backup of the user's home directory using rsync.
#Author : Kone Venkata Nagendra Kumar
#Version : 1.0
